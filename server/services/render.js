...
exports.records = (req, res) => {
    // Make a get request to /api/users
    axios.get('https://digy4-database.herokuapp.com/records')
        .then(function(response){
...
exports.emails = (req, res) => {
    // Make a get request to /api/users
    axios.get('https://digy4-database.herokuapp.com/emails')
        .then(function(response){
...
exports.contacts = (req, res) => {
    // Make a get request to /api/users
    axios.get('https://digy4-database.herokuapp.com/contacts?=id')
        .then(function(response){
...
exports.locations = (req, res) => {
    // Make a get request to /api/users
    axios.get('https://digy4-database.herokuapp.com/locations')
        .then(function(response){
...
exports.reviews = (req, res) => {
    // Make a get request to /api/users
    axios.get('https://digy4-database.herokuapp.com/reviews')
        .then(function(response){
...
exports.update_record = (req, res) =>{
    axios.get('https://digy4-database.herokuapp.com/records', { params : { id : req.query.id }})
...
exports.update_contact = (req, res) =>{
    axios.get('https://digy4-database.herokuapp.com/contacts', { params : { id : req.query.id }})
...
exports.update_location = (req, res) =>{
    axios.get('https://digy4-database.herokuapp.com/locations', { params : { id : req.query.id }})
...
exports.update_email = (req, res) =>{
    axios.get('https://digy4-database.herokuapp.com/emails', { params : { id : req.query.id }})
...
exports.update_review = (req, res) =>{
    axios.get('https://digy4-database.herokuapp.com/reviews', { params : { id : req.query.id }})
